...
t.which == 27 && e.hide();
        ...
        backdrop: function(t) {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                this.$backdrop = e('<div class="modal-backdrop ' + r + '" />').appendTo(document.body), this.$backdrop
.click(this.options.backdrop == "static" ? e.proxy(this.$element[0].focus, this.$element[0]) : e.proxy(this.hide, this)), i && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), i ? this.$backdrop.one(e.support.transition.end, t) : t();
    ...
    e.fn.modal = function(n) {
        ...
        keyboard: !0,
        show: !0
    }, e.fn.modal.Constructor = t, e.fn.modal
.noConflict = function() {
