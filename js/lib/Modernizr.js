...
for (var r = 0, i = n.length; r < i; r++) w[n[r]] = n[r] in l;
    ...
    var r = "2.6.2"
, i = {}, s = !0, o = t.documentElement, u = "modernizr", a = t.createElement(u), f = a.style, l = t.createElement("input"), c = ":)", h = {}.toString, p = " -webkit- -moz- -o- -ms- ".split(" "), d = "Webkit Moz O ms", v = d.split(" "), m = d.toLowerCase().split(" "), g = {
...
t) {
    ...
    !M(k, "undefined") && !
M(k.call, "undefined") ? L = function(e, t) {
        return k.call(e, t);
    } : L = function(e, t) {
...
t.offsetHeight === 3;
        ...
        try {
            if (n = !!e.canPlayType) n = new Boolean(n), n.ogg = e.canPlayType('video/ogg; codecs="theora"').replace(/^no$/, ""), n.h264 = e.canPlayType('video/mp4; codecs="avc1.42E01E"'
).replace(/^no$/, ""), n.webm = e.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/, "");
        } catch (r) {}
        return n;
    }, y.audio = function() {
...
[e] !== n) return i;
        ...
        function p(e, n, s) {
            ...
            s || (s = h(n));
            var o;
            return s.cache[e] ? o = s.cache[e].cloneNode() : i.test(e) ? o = (s.cache[e] = s.createElem(e)).cloneNode() : o = 
s.createElem(e), o.canHaveChildren && !r.test(e) ? s.frag.appendChild(o) : o;
        }
        function d(e, n) {
            e || (e = t);
