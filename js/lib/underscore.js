...
function(e, t, n) {
    ...
    x.flatten = function(e, t) {
        ...
        return T(i, function(n, r) {
            if (t ? !r || o[o.length - 1] !== n : !x.contains(o, n)) o.push(n), s.push
(e[r]);
        }), s;
    }, x.union = function() {
...
, i = e.length;
    ...
    x.bind = function(e, t) {
        var n, r;
        if (e.bind === S && S) return S.apply(e, u.call(arguments
, 1));
        ...
        return setTimeout(function() 
{
        ...
        return x
.isObject(e) ? x.isArray(e) ? e.slice() : x.extend({}, e) : e;
    }, x.tap = function(e, t) {
        return t(e), e;
    };
